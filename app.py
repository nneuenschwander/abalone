...
st.markdown("""$ weight \Delta = whole weight - (shucked weight - viscera weight - shell weight) $ The weight $\Delta$ should be greater than 0 in all cases, as the whole weight should include some discard of the initial abalone not accouned for in the 3 parital weight features. However, we can see that there are records where the weight $\Delta$ is negative""")